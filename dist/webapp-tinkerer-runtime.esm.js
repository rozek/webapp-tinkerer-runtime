...
export { AppletDeserializedFrom, AppletHasBackup, AppletMayBePreserved, AppletPeersInDocument, AppletsMayBePreserved, CategoryOfMaster, ClassesOfMaster, DuplicateOfMaster, ErrorInfoOfMaster, IndexOfPropertyOfMaster, MasterHasProperty, MasterLacksProperty, Masters, MastersUsedByVisuals, NameOfMaster, PropertiesOfMaster, PropertyCountOfMaster, PropertyDescriptorFor, PropertyNamesOfMaster, PropertyOfMaster, PropertyOfMasterMayBeMovedDown, PropertyOfMasterMayBeMovedUp, ResourcesOfMaster, ScriptOfMaster, StylesOfMaster, TemplateOfMaster, UsageCountOfMaster, ValueIsApplet, ValueIsCard, ValueIsComponent, ValueIsCompound, ValueIsContainer, ValueIsControl, ValueIsDimension, ValueIsElement, ValueIsId, ValueIsIdentifier, ValueIsLabel, ValueIsLocation, ValueIsName, ValueIsOverlay, ValueIsSemVer, ValueIsUniqueId, ValueIsUniversalName, ValueIsVisual, Version, VersionOfMaster, VisualForElement, WAT_Applet, WAT_BackgroundModes, WAT_BorderStyles, WAT_Card, WAT_Categories, WAT_Compound, WAT_Container, WAT_Control, WAT_Cursors, WAT_FontStyles, WAT_FontWeightValues, WAT_FontWeights, WAT_Layer, WAT_Overflows, WAT_Overlay, WAT_PropertyEditorTypes, WAT_TextAlignments, WAT_TextDecorationLines, WAT_TextDecorationStyles, WAT_TextOverflows, WAT_Visual, WAT_horizontalAnchorings, WAT_verticalAnchorings, activatePendingClassesOfMaster, activatePendingResourcesOfMaster, activatePendingScriptOfMaster, activatePendingStylesOfMaster, activatePendingTemplateOfMaster, allowApplet, allowCard, allowComponent, allowCompound, allowContainer, allowControl, allowDimension, allowElement, allowId, allowIdentifier, allowLabel, allowLocation, allowName, allowOverlay, allowSemVer, allowUniqueId, allowUniversalName, allowVisual, allowedApplet, allowedCard, allowedComponent, allowedCompound, allowedContainer, allowedControl, allowedDimension, allowedElement, allowedId, allowedIdentifier, allowedLabel, allowedLocation, allowedName, allowedOverlay, allowedSemVer, allowedUniqueId, allowedUniversalName, allowedVisual, changePropertyOfMaster, createMaster, deserializedMaster, expectApplet, expectCard, expectComponent, expectCompound, expectContainer, expectControl, expectDimension, expectElement, expectId, expectIdentifier, expectLabel, expectLocation, expectName, expectOverlay, expectSemVer, expectUniqueId, expectUniversalName, expectVisual, expectedApplet, expectedCard, expectedComponent, expectedCompound, expectedContainer, expectedControl, expectedDimension, expectedElement, expectedId, expectedIdentifier, expectedLabel, expectedLocation, expectedName, expectedOverlay, expectedSemVer, expectedUniqueId, expectedUniversalName, expectedVisual, hasMaster, insertPropertyOfMasterAt, instantiableComponentMasters, instantiableLayerMasters, instantiableMasters, lacksMaster, missingMasters, movePropertyOfMasterDown, movePropertyOfMasterTo, movePropertyOfMasterToBottom, movePropertyOfMasterToTop, movePropertyOfMasterUp, newUniqueId, parsedSerialization, pendingClassesOfMaster, pendingResourcesOfMaster, pendingScriptOfMaster, pendingStylesOfMaster, pendingTemplateOfMaster, preserveApplet, ready, registerDesigner, registerMasterFromSerialization, registerResources, registeredMasters, removeBackupOfApplet, removePropertyOfMaster, renameMaster, renamePropertyOfMaster, restoreApplet, running, serializedMaster, setNameOfMaster, setPendingClassesOfMaster, setPendingResourcesOfMaster, setPendingScriptOfMaster, setPendingStylesOfMaster, setPendingTemplateOfMaster, setVersionOfMaster, throwReadOnlyError, throwWriteOnlyError, unregisterMaster, unregisterResources, unusedMasters };
