(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
        var current = global.WAT;
        var exports = global.WAT = {};
        factory(exports);
        exports.noConflict = function () { global.WAT = current; return exports; };
    }()));
    ...
    *******************************************************************************/
    ...
    var allowElement = ValidatorForClassifier(ValueIsElement, acceptNil, 'DOM element'), allowedElement = allowElement;
    var expectElement = ValidatorForClassifier(ValueIsElement, rejectNil, 'DOM element'), expectedElement = expectElement;
    /**** ValueIsVisual ****/
    function ValueIsVisual(Value) {
        return (Value instanceof WAT_Visual);
    }
    /**** allow/expect[ed]Visual ****/
    var allowVisual = ValidatorForClassifier(ValueIsVisual, acceptNil, 'WAT visual'), allowedVisual = allowVisual;
    var expectVisual = ValidatorForClassifier(ValueIsVisual, rejectNil, 'WAT visual'), expectedVisual = expectVisual;
    /**** ValueIsApplet ****/
    function ValueIsApplet(Value) {
        return (Value instanceof WAT_Applet);
    }
    /**** allow/expect[ed]Applet ****/
    var allowApplet = ValidatorForClassifier(ValueIsApplet, acceptNil, 'WAT applet'), allowedApplet = allowApplet;
    var expectApplet = ValidatorForClassifier(ValueIsApplet, rejectNil, 'WAT applet'), expectedApplet = expectApplet;
    /**** ValueIsCard ****/
    function ValueIsCard(Value) {
        return (Value instanceof WAT_Card);
    }
    /**** allow/expect[ed]Card ****/
    var allowCard = ValidatorForClassifier(ValueIsCard, acceptNil, 'WAT card'), allowedCard = allowCard;
    var expectCard = ValidatorForClassifier(ValueIsCard, rejectNil, 'WAT card'), expectedCard = expectCard;
    /**** ValueIsOverlay ****/
    function ValueIsOverlay(Value) {
        return (Value instanceof WAT_Overlay);
    }
    /**** allow/expect[ed]Overlay ****/
    var allowOverlay = ValidatorForClassifier(ValueIsOverlay, acceptNil, 'WAT overlay'), allowedOverlay = allowOverlay;
    var expectOverlay = ValidatorForClassifier(ValueIsOverlay, rejectNil, 'WAT overlay'), expectedOverlay = expectOverlay;
    /**** ValueIsControl ****/
    function ValueIsControl(Value) {
        return (Value instanceof WAT_Control);
    }
    /**** allow/expect[ed]Control ****/
    var allowControl = ValidatorForClassifier(ValueIsControl, acceptNil, 'WAT control'), allowedControl = allowControl;
    var expectControl = ValidatorForClassifier(ValueIsControl, rejectNil, 'WAT control'), expectedControl = expectControl;
    /**** ValueIsCompound ****/
    function ValueIsCompound(Value) {
        return (Value instanceof WAT_Compound);
    }
    /**** allow/expect[ed]Compound ****/
    var allowCompound = ValidatorForClassifier(ValueIsCompound, acceptNil, 'WAT compound'), allowedCompound = allowCompound;
    var expectCompound = ValidatorForClassifier(ValueIsCompound, rejectNil, 'WAT compound'), expectedCompound = expectCompound;
    /**** ValueIsComponent ****/
    ...
    var allowComponent = ValidatorForClassifier(ValueIsComponent, acceptNil, 'WAT component'), allowedComponent = allowComponent;
    var expectComponent = ValidatorForClassifier(ValueIsComponent, rejectNil, 'WAT component'), expectedComponent = expectComponent;
    /**** ValueIsContainer ****/
    ...
    var allowUniqueId = ValidatorForClassifier(ValueIsUniqueId, acceptNil, 'unique WAT id'), allowedUniqueId = allowUniqueId;
    var expectUniqueId = ValidatorForClassifier(ValueIsUniqueId, rejectNil, 'unique WAT id'), expectedUniqueId = expectUniqueId;
    ...
    /**** allow/expect[ed]Id ****/
    var allowId = ValidatorForClassifier(ValueIsId, acceptNil, 'WAT HTML id'), allowedId = allowId;
    var expectId = ValidatorForClassifier(ValueIsId, rejectNil, 'WAT HTML id'), expectedId = expectId;
    /**** ValueIsName ****/
    ...
    var allowName = ValidatorForClassifier(ValueIsName, acceptNil, 'WAT name'), allowedName = allowName;
    var expectName = ValidatorForClassifier(ValueIsName, rejectNil, 'WAT name'), expectedName = expectName;
    ...
    var allowUniversalName = ValidatorForClassifier(ValueIsUniversalName, acceptNil, 'WAT name'), allowedUniversalName = allowUniversalName;
    var expectUniversalName = ValidatorForClassifier(ValueIsUniversalName, rejectNil, 'WAT name'), expectedUniversalName = expectUniversalName;
    /**** ValueIsLabel ****/
    function ValueIsLabel(Value) {
        return ValueIsTextline(Value);
    }
    /**** allow/expect[ed]Label ****/
    var allowLabel = ValidatorForClassifier(ValueIsLabel, acceptNil, 'WAT visual label'), allowedLabel = allowLabel;
    var expectLabel = ValidatorForClassifier(ValueIsLabel, rejectNil, 'WAT visual label'), expectedLabel = expectLabel;
    /**** ValueIsIdentifier ****/
    ...
    var allowIdentifier = ValidatorForClassifier(ValueIsIdentifier, acceptNil, 'WAT identifier'), allowedIdentifier = allowIdentifier;
    var expectIdentifier = ValidatorForClassifier(ValueIsIdentifier, rejectNil, 'WAT identifier'), expectedIdentifier = expectIdentifier;
    /**** ValueIsLocation ****/
    function ValueIsLocation(Value) {
        return ValueIsFiniteNumber(Value);
    }
    /**** allow/expect[ed]Location ****/
    var allowLocation = ValidatorForClassifier(ValueIsLocation, acceptNil, 'coordinate'), allowedLocation = allowLocation;
    var expectLocation = ValidatorForClassifier(ValueIsLocation, rejectNil, 'coordinate'), expectedLocation = expectLocation;
    /**** ValueIsDimension ****/
    function ValueIsDimension(Value) {
        return ValueIsFiniteNumber(Value) && (Value >= 0);
    }
    /**** allow/expect[ed]Dimension ****/
    var allowDimension = ValidatorForClassifier(ValueIsDimension, acceptNil, 'extent'), allowedDimension = allowDimension;
    var expectDimension = ValidatorForClassifier(ValueIsDimension, rejectNil, 'extent'), expectedDimension = expectDimension;
    /**** ValueIsSemVer ****/
    ...
    var allowSemVer = ValidatorForClassifier(ValueIsSemVer, acceptNil, 'version specification'), allowedSemVer = allowSemVer;
    var expectSemVer = ValidatorForClassifier(ValueIsSemVer, rejectNil, 'version specification'), expectedSemVer = expectSemVer;
    /**** throwReadOnlyError ****/
    ...
    function expectedProperty(Description, Value) {
        ...
        switch (true) {
            ...
            case !ValueIsOneOf(EditorType, WAT_PropertyEditorTypes): throwError('InvalidArgument: invalid editor type given for property ' + quoted(Identifier));
        }
    ...
    function parsedMaster(MasterObject) {
        ...
        var Name = expectedName('master name', MasterObject.Name);
        if (Name.startsWith('#')) {
            throwError('InvalidImport: the name of a master must not be global');
        }
        var Version = normalized(parsedVersion(allowedSemVer('master version', MasterObject.Version) || '0.0.1'));
    ...
    function registerEventHandlerForVisual(Visual) {
        ...
        if (ValueIsString(ArgumentList[0]) && ArgumentList[0].startsWith('@')) {
            ...
            if (TapPointSelector_1[0] === '.') {
                expectName('tap point master name', TapPointSelector_1.slice(1));
                TapElement = closestParent(Visual.Peer, '.WAT' + TapPointSelector_1);
            }
            else {
                expectUniversalName('tap point name', TapPointSelector_1);
    ...
    function unregisterEventHandlerForVisual(Visual) {
        ...
        if (ValueIsString(ArgumentList[0]) && ArgumentList[0].startsWith('@')) {
            ...
            if (TapPointSelector_2[0] === '.') {
                expectName('tap point master name', TapPointSelector_2.slice(1));
                TapElement = closestParent(Visual.Peer, '.WAT' + TapPointSelector_2);
            }
            else {
                expectUniversalName('tap point name', TapPointSelector_2);
    ...
    function triggerEventFromVisual(Visual) {
        ...
        if (ValueIsString(ArgumentList[0]) && ArgumentList[0].startsWith('@')) {
            ...
            if (InjectionPointSelector_1[0] === '.') {
                expectName('injection point master name', InjectionPointSelector_1.slice(1));
                InjectionElement = closestParent(Visual.Peer, '.WAT' + InjectionPointSelector_1);
            }
            else {
                expectUniversalName('injection point name', InjectionPointSelector_1);
    ...
    exports.AppletDeserializedFrom = AppletDeserializedFrom;
    exports.AppletHasBackup = AppletHasBackup;
    exports.AppletMayBePreserved = AppletMayBePreserved;
    exports.AppletPeersInDocument = AppletPeersInDocument;
    exports.AppletsMayBePreserved = AppletsMayBePreserved;
    exports.CategoryOfMaster = CategoryOfMaster;
    exports.ClassesOfMaster = ClassesOfMaster;
    exports.DuplicateOfMaster = DuplicateOfMaster;
    exports.ErrorInfoOfMaster = ErrorInfoOfMaster;
    exports.IndexOfPropertyOfMaster = IndexOfPropertyOfMaster;
    exports.MasterHasProperty = MasterHasProperty;
    exports.MasterLacksProperty = MasterLacksProperty;
    exports.Masters = Masters;
    exports.MastersUsedByVisuals = MastersUsedByVisuals;
    exports.NameOfMaster = NameOfMaster;
    exports.PropertiesOfMaster = PropertiesOfMaster;
    exports.PropertyCountOfMaster = PropertyCountOfMaster;
    exports.PropertyDescriptorFor = PropertyDescriptorFor;
    exports.PropertyNamesOfMaster = PropertyNamesOfMaster;
    exports.PropertyOfMaster = PropertyOfMaster;
    exports.PropertyOfMasterMayBeMovedDown = PropertyOfMasterMayBeMovedDown;
    exports.PropertyOfMasterMayBeMovedUp = PropertyOfMasterMayBeMovedUp;
    exports.ResourcesOfMaster = ResourcesOfMaster;
    exports.ScriptOfMaster = ScriptOfMaster;
    exports.StylesOfMaster = StylesOfMaster;
    exports.TemplateOfMaster = TemplateOfMaster;
    exports.UsageCountOfMaster = UsageCountOfMaster;
    exports.ValueIsApplet = ValueIsApplet;
    exports.ValueIsCard = ValueIsCard;
    exports.ValueIsComponent = ValueIsComponent;
    exports.ValueIsCompound = ValueIsCompound;
    exports.ValueIsContainer = ValueIsContainer;
    exports.ValueIsControl = ValueIsControl;
    exports.ValueIsDimension = ValueIsDimension;
    exports.ValueIsElement = ValueIsElement;
    exports.ValueIsId = ValueIsId;
    exports.ValueIsIdentifier = ValueIsIdentifier;
    exports.ValueIsLabel = ValueIsLabel;
    exports.ValueIsLocation = ValueIsLocation;
    exports.ValueIsName = ValueIsName;
    exports.ValueIsOverlay = ValueIsOverlay;
    exports.ValueIsSemVer = ValueIsSemVer;
    exports.ValueIsUniqueId = ValueIsUniqueId;
    exports.ValueIsUniversalName = ValueIsUniversalName;
    exports.ValueIsVisual = ValueIsVisual;
    exports.Version = Version;
    exports.VersionOfMaster = VersionOfMaster;
    exports.VisualForElement = VisualForElement;
    exports.WAT_Applet = WAT_Applet;
    exports.WAT_BackgroundModes = WAT_BackgroundModes;
    exports.WAT_BorderStyles = WAT_BorderStyles;
    exports.WAT_Card = WAT_Card;
    exports.WAT_Categories = WAT_Categories;
    exports.WAT_Compound = WAT_Compound;
    exports.WAT_Container = WAT_Container;
    exports.WAT_Control = WAT_Control;
    ...
    exports.WAT_Layer = WAT_Layer;
    exports.WAT_Overflows = WAT_Overflows;
    exports.WAT_Overlay = WAT_Overlay;
    exports.WAT_PropertyEditorTypes = WAT_PropertyEditorTypes;
    ...
    exports.WAT_Visual = WAT_Visual;
    exports.WAT_horizontalAnchorings = WAT_horizontalAnchorings;
    exports.WAT_verticalAnchorings = WAT_verticalAnchorings;
    exports.activatePendingClassesOfMaster = activatePendingClassesOfMaster;
    exports.activatePendingResourcesOfMaster = activatePendingResourcesOfMaster;
    exports.activatePendingScriptOfMaster = activatePendingScriptOfMaster;
    exports.activatePendingStylesOfMaster = activatePendingStylesOfMaster;
    exports.activatePendingTemplateOfMaster = activatePendingTemplateOfMaster;
    exports.allowApplet = allowApplet;
    exports.allowCard = allowCard;
    exports.allowComponent = allowComponent;
    exports.allowCompound = allowCompound;
    exports.allowContainer = allowContainer;
    exports.allowControl = allowControl;
    exports.allowDimension = allowDimension;
    exports.allowElement = allowElement;
    exports.allowId = allowId;
    exports.allowIdentifier = allowIdentifier;
    exports.allowLabel = allowLabel;
    exports.allowLocation = allowLocation;
    exports.allowName = allowName;
    exports.allowOverlay = allowOverlay;
    exports.allowSemVer = allowSemVer;
    exports.allowUniqueId = allowUniqueId;
    exports.allowUniversalName = allowUniversalName;
    exports.allowVisual = allowVisual;
    exports.allowedApplet = allowedApplet;
    exports.allowedCard = allowedCard;
    exports.allowedComponent = allowedComponent;
    exports.allowedCompound = allowedCompound;
    exports.allowedContainer = allowedContainer;
    exports.allowedControl = allowedControl;
    exports.allowedDimension = allowedDimension;
    exports.allowedElement = allowedElement;
    exports.allowedId = allowedId;
    exports.allowedIdentifier = allowedIdentifier;
    exports.allowedLabel = allowedLabel;
    exports.allowedLocation = allowedLocation;
    exports.allowedName = allowedName;
    exports.allowedOverlay = allowedOverlay;
    exports.allowedSemVer = allowedSemVer;
    exports.allowedUniqueId = allowedUniqueId;
    exports.allowedUniversalName = allowedUniversalName;
    exports.allowedVisual = allowedVisual;
    exports.changePropertyOfMaster = changePropertyOfMaster;
    exports.createMaster = createMaster;
    exports.deserializedMaster = deserializedMaster;
    exports.expectApplet = expectApplet;
    exports.expectCard = expectCard;
    exports.expectComponent = expectComponent;
    exports.expectCompound = expectCompound;
    exports.expectContainer = expectContainer;
    exports.expectControl = expectControl;
    exports.expectDimension = expectDimension;
    exports.expectElement = expectElement;
    exports.expectId = expectId;
    exports.expectIdentifier = expectIdentifier;
    exports.expectLabel = expectLabel;
    exports.expectLocation = expectLocation;
    exports.expectName = expectName;
    exports.expectOverlay = expectOverlay;
    exports.expectSemVer = expectSemVer;
    exports.expectUniqueId = expectUniqueId;
    exports.expectUniversalName = expectUniversalName;
    exports.expectVisual = expectVisual;
    exports.expectedApplet = expectedApplet;
    exports.expectedCard = expectedCard;
    exports.expectedComponent = expectedComponent;
    exports.expectedCompound = expectedCompound;
    exports.expectedContainer = expectedContainer;
    exports.expectedControl = expectedControl;
    exports.expectedDimension = expectedDimension;
    exports.expectedElement = expectedElement;
    exports.expectedId = expectedId;
    exports.expectedIdentifier = expectedIdentifier;
    exports.expectedLabel = expectedLabel;
    exports.expectedLocation = expectedLocation;
    exports.expectedName = expectedName;
    exports.expectedOverlay = expectedOverlay;
    exports.expectedSemVer = expectedSemVer;
    exports.expectedUniqueId = expectedUniqueId;
    exports.expectedUniversalName = expectedUniversalName;
    exports.expectedVisual = expectedVisual;
    exports.hasMaster = hasMaster;
    exports.insertPropertyOfMasterAt = insertPropertyOfMasterAt;
    exports.instantiableComponentMasters = instantiableComponentMasters;
    exports.instantiableLayerMasters = instantiableLayerMasters;
    exports.instantiableMasters = instantiableMasters;
    exports.lacksMaster = lacksMaster;
    exports.missingMasters = missingMasters;
    exports.movePropertyOfMasterDown = movePropertyOfMasterDown;
    exports.movePropertyOfMasterTo = movePropertyOfMasterTo;
    exports.movePropertyOfMasterToBottom = movePropertyOfMasterToBottom;
    exports.movePropertyOfMasterToTop = movePropertyOfMasterToTop;
    exports.movePropertyOfMasterUp = movePropertyOfMasterUp;
    exports.newUniqueId = newUniqueId;
    exports.parsedSerialization = parsedSerialization;
    exports.pendingClassesOfMaster = pendingClassesOfMaster;
    exports.pendingResourcesOfMaster = pendingResourcesOfMaster;
    exports.pendingScriptOfMaster = pendingScriptOfMaster;
    exports.pendingStylesOfMaster = pendingStylesOfMaster;
    exports.pendingTemplateOfMaster = pendingTemplateOfMaster;
    exports.preserveApplet = preserveApplet;
    exports.ready = ready;
    ...
    exports.renamePropertyOfMaster = renamePropertyOfMaster;
    exports.restoreApplet = restoreApplet;
    exports.running = running;
    exports.serializedMaster = serializedMaster;
    exports.setNameOfMaster = setNameOfMaster;
    exports.setPendingClassesOfMaster = setPendingClassesOfMaster;
    exports.setPendingResourcesOfMaster = setPendingResourcesOfMaster;
    exports.setPendingScriptOfMaster = setPendingScriptOfMaster;
    exports.setPendingStylesOfMaster = setPendingStylesOfMaster;
    exports.setPendingTemplateOfMaster = setPendingTemplateOfMaster;
    exports.setVersionOfMaster = setVersionOfMaster;
    exports.throwReadOnlyError = throwReadOnlyError;
    exports.throwWriteOnlyError = throwWriteOnlyError;
    exports.unregisterMaster = unregisterMaster;
    exports.unregisterResources = unregisterResources;
    exports.unusedMasters = unusedMasters;
