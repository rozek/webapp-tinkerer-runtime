...
*(currently under active development, please stay tuned - to be finished by end of september)*
...
"Serializations" of whole applets or individual visuals are the HTML markup needed to restore them (or make copies). They may contain any required masters and resources or do without them.
...
Additional serialization and deserialization methods can be found in classes [WAT_Applet](#wat_applet) and [WAT_Container](#wat_container)
...
* **`unregisterMaster (Name:WAT_Name):void`**<br>removes the master called `Name` from the registry. It is permitted to remove a non-existing master - in that case, the function is simply ignored
...
* **`Card (CardOrNameOrIndex:WAT_Card|WAT_Name|number):WAT_Card|undefined`**<br>returns this applet's card with the given `CardOrNameOrIndex` - or `undefined` if no such card exists. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`CardAtIndex (Index:number):WAT_Card|undefined`**<br>returns this applet's card at the given `Index` - or `undefined` if no such card exists
* **`CardNamed (Name:WAT_Name):WAT_Card|undefined`**<br>returns the first card in this applet with the given `Name` - or `undefined` if no such card exists
* **`CardLabelled (Label:WAT_Label):WAT_Card|undefined`**<br>returns the first card in this applet with the given `Label` - or `undefined` if no such card exists
* **`IndexOfCard (CardOrNameOrIndex:WAT_Card|WAT_Name|number):number`**<br>returns the index of this applet's card with the given `CardOrNameOrIndex` - or `undefined` if no such card exists. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`acceptsCardAt (CardOrNameOrIndex:WAT_Card|WAT_Name|number, InsertionPoint?:WAT_Card|WAT_Name|number):boolean`**<br>returns `true` if this applet allows the given `CardOrNameOrIndex` to be inserted at the given `InsertionPoint` - or `false` otherwise. Both `CardOrNameOrIndex` and `InsertionPoint` may be set to a specific card, a card name or a card's index in the list of cards in this applet. If `InsertionPoint` is missing, it is assumed that the card should be appended
* **`acceptsNewCardAt (Master:WAT_Name, InsertionPoint?:WAT_Card|WAT_Name|number):boolean`**<br>returns `true` if this applet allows a new card based on the given `Master` to be inserted at the given `InsertionPoint` - or `false` otherwise. `InsertionPoint` may be set to a specific card, a card name or a card's index in the list of cards in this applet. If it is missing, it is assumed that the new card should be appended
* **`newCardInsertedAt (Master:WAT_Name, InsertionPoint?:WAT_Card|WAT_Name|number):WAT_Card`**<br>creates a new card based on the given `Master` and inserts it at the given `InsertionPoint`. `InsertionPoint` may be set to a specific card, a card name or a card's index in the list of cards in this applet. If it is missing, the new card is appended to the list of already existing cards
* **`DuplicateOfCard (CardOrNameOrIndex:WAT_Card|WAT_Name|number):WAT_Card`**<br>creates a duplicate of the given `CardOrNameOrIndex`and inserts it right after the original. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`CardDeserializedFrom (Serialization:string, InsertionPoint?:WAT_Card|WAT_Name|number):WAT_Card`**<br>creates a new card from the given `Serialization` and inserts it at the given `InsertionPoint`. `InsertionPoint` may be set to a specific card, a card name or a card's index in the list of cards in this applet. If it is missing, the new card is appended to the list of already existing cards
* **`CardMayBeShiftedUp (CardOrNameOrIndex:WAT_Card|WAT_Name|number):boolean`**<br>returns `true` if the given `CardOrNameOrIndex` may be moved one position "up" (i.e. towards lower indices) in the list of cards of this applet - or `false` otherwise. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`CardMayBeShiftedDown (CardOrNameOrIndex:WAT_Card|WAT_Name|number):boolean`**<br>returns `true` if the given `CardOrNameOrIndex` may be moved one position "down" (i.e. towards higher indices) in the list of cards of this applet - or `false` otherwise. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`CardMayBeShiftedTo (CardOrNameOrIndex:WAT_Card|WAT_Name|number, InsertionPoint:WAT_Card|WAT_Name|number):boolean`**<br>returns `true` if the given `CardOrNameOrIndex` may be moved to the position given by `InsertionPoint` in the list of cards of this applet - or `false` otherwise. Both `CardOrNameOrIndex` and `InsertionPoint` may be set to a specific card, a card name or a card's index in the list of cards in this applet. If it is missing, it is assumed that the given card should be appended
* **`shiftCardUp (CardOrNameOrIndex:WAT_Card|WAT_Name|number):void`**<br>moves the given `CardOrNameOrIndex` one position "up" (i.e. towards lower indices) in the list of cards of this applet - provided that this is possible. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`shiftCardDown (CardOrNameOrIndex:WAT_Card|WAT_Name|number):void`**<br>moves the given `CardOrNameOrIndex` one position "down" (i.e. towards higher indices) in the list of cards of this applet - provided that this is possible. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
...
* **`removeCard (CardOrNameOrIndex:WAT_Card|WAT_Name|number):void`**<br>removes the given `CardOrNameOrIndex` - provided that this is possible. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet. It is permitted to remove a non-existing card - in that case, the function is simply ignored
...
* **`CardIsShown (CardOrNameOrIndex:WAT_Card|WAT_Name|number):boolean`**<br>contains `true` if the given `CardOrNameOrIndex` is shown - or `false` otherwise. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
* **`showCard (CardOrNameOrIndex:WAT_Card|WAT_Name|number):void`**<br>makes the given `CardOrNameOrIndex` the shown card of this applet. `CardOrNameOrIndex` may be set to a specific card, a card name or a card's index in the list of cards in this applet
...
* **`OverlayList:WAT_Overlay[]`**<br>contains a list with this applet's overlays in their current order
* **`OverlayLabelList:WAT_Label[]`**<br>contains a list with the labels of this applet's overlays in their current order
* **`OverlayCount:number`**<br>contains the number of overlays in this applet
* **`Overlay (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):WAT_Overlay|undefined`**<br>returns this applet's overlay with the given `OverlayOrNameOrIndex` - or undefined if no such overlay exists. `OverlayOrNameOrInde`x may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays of this applet
* **`OverlayAtIndex (Index:number):WAT_Overlay|undefined`**<br>returns this applet's overlay at the given `Index` - or undefined if no such overlay exists
* **`OverlayNamed (Name:WAT_Name):WAT_Overlay|undefined`**<br>returns the first overlay in this applet with the given `Name` - or undefined if no such overlay exists
* **`OverlayLabelled (Label:WAT_Label):WAT_Overlay|undefined`**<br>returns the first overlay in this applet with the given `Label` - or undefined if no such overlay exists
* **`IndexOfOverlay (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):number`**<br>returns the index of this applet's overlay with the given `OverlayOrNameOrIndex` - or undefined if no such overlay exists. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
* **`acceptsOverlayAt (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number, InsertionPoint?:WAT_Overlay|WAT_Name|number):boolean`**<br>returns `true` if this applet allows the given `OverlayOrNameOrIndex` to be inserted at the given `InsertionPoint` - or `false` otherwise. Both `OverlayOrNameOrIndex` and `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If `InsertionPoint` is missing, it is assumed that the overlay should be appended
* **`acceptsNewOverlayAt (Master:WAT_Name, InsertionPoint?:WAT_Overlay|WAT_Name|number):boolean`**<br>returns `true` if this applet allows a new overlay based on the given `Master` to be inserted at the given `InsertionPoint` - or `false` otherwise. `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If it is missing, it is assumed that the new overlay should be appended
* **`newOverlayInsertedAt (Master:WAT_Name, InsertionPoint?:WAT_Overlay|WAT_Name|number):WAT_Overlay`**<br>creates a new overlay based on the given `Master` and inserts it at the given `InsertionPoint`. `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If it is missing, the new overlay is appended to the list of already existing overlays
* **`DuplicateOfOverlay (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):WAT_Overlay`**<br>creates a duplicate of the given `OverlayOrNameOrIndex`and inserts it right after the original. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
* **`OverlayDeserializedFrom (Serialization:string, OverlayOrNameOrIndex?:WAT_Overlay|WAT_Name|number):WAT_Overlay`**<br>creates a new overlay from the given `Serialization` and inserts it at the given `InsertionPoint`. `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If it is missing, the new overlay is appended to the list of already existing overlays
* **`OverlayMayBeShiftedUp (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):boolean`**<br>returns `true` if the given `OverlayOrNameOrIndex` may be moved one position "up" (i.e. towards lower indices) in the list of overlays of this applet - or `false` otherwise. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
* **`OverlayMayBeShiftedDown (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):boolean`**<br>returns `true` if the given `OverlayOrNameOrIndex` may be moved one position "down" (i.e. towards higher indices) in the list of overlays of this applet - or `false` otherwise. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
* **`OverlayMayBeShiftedTo (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number, InsertionPoint:WAT_Overlay|WAT_Name|number):boolean`**<br>returns `true` if the given `OverlayOrNameOrIndex` may be moved to the position given by `InsertionPoint` in the list of overlays of this applet - or `false` otherwise. Both `OverlayOrNameOrIndex` and `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If it is missing, it is assumed that the given overlay should be appended
* **`shiftOverlayUp (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):void`**<br>moves the given `OverlayOrNameOrIndex` one position "up" (i.e. towards lower indices) in the list of overlays of this applet - provided that this is possible. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
* **`shiftOverlayDown (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):void`**<br>moves the given `OverlayOrNameOrIndex` one position "down" (i.e. towards higher indices) in the list of overlays of this applet - provided that this is possible. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
* **`shiftOverlayTo (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number, InsertionPoint:WAT_Overlay|WAT_Name|number):void`**<br>moves the given `OverlayOrNameOrIndex` to the position given by `InsertionPoint` in the list of overlays of this applet - provided that this is possible. Both `OverlayOrNameOrIndex` and `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If it is missing, it is assumed that the given overlay should be appended
* **`removeOverlay (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number):void`**<br>removes the given `OverlayOrNameOrIndex` - provided that this is possible. `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. It is permitted to remove a non-existing overlay - in that case, the function is simply ignored
* **`frontmostOverlayOfClass (ClassName:WAT_Name):WAT_Overlay | undefined`**<br>contains the frontmost visible overlay of this applet with the given CSS `ClassName` - or `undefined` if no such overlay exists
* **`bringOverlayToFrontOfClass (OverlayOrNameOrIndex:WAT_Overlay|WAT_Name|number, ClassName:WAT_Name):void`**<br>makes the given `OverlayOrNameOrIndex` the frontmost one of this applet with the given CSS `ClassName`. The specified overlay must contain the given CSS class itself, `OverlayOrNameOrIndex` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet
...
* **`ComponentList:WAT_Component[]`**<br>contains a list with this container's components in their current order
* **`ComponentLabelList:WAT_Label[]`**<br>contains a list with the labels of this container's components in their current order
* **`ComponentCount:number`**<br>contains the number of components in this container
* **`Component (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):WAT_Component|undefined`**<br>returns this container's component with the given `ComponentOrNameOrIndex` - or `undefined` if no such component exists. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`ComponentAtIndex (Index:number):WAT_Component|undefined`**<br>returns this container's component at the given `Index` - or `undefined` if no such component exists
* **`ComponentNamed (Name:WAT_Name):WAT_Component|undefined`**<br>returns the first component in this container with the given `Name` - or `undefined` if no such component exists
* **`ComponentLabelled (Label:WAT_Label):WAT_Component|undefined`**<br>returns the first component in this container with the given `Label` - or `undefined` if no such component exists
* **`IndexOfComponent (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):number`**<br>returns the index of this container's component with the given `ComponentOrNameOrIndex` - or `undefined` if no such component exists. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`acceptsComponentAt (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number, InsertionPoint?:WAT_Component|WAT_Name|number):boolean`**<br>returns `true` if this container allows the given `ComponentOrNameOrIndex` to be inserted at the given `InsertionPoint` - or `false` otherwise. Both `ComponentOrNameOrIndex` and `InsertionPoint` may be set to a specific component, a component name or a component's index in the list of components in this container. If `InsertionPoint` is missing, it is assumed that the component should be appended
* **`acceptsNewComponentAt (Master:WAT_Name, InsertionPoint?:WAT_Component|WAT_Name|number):boolean`**<br>returns `true` if this container allows a new component based on the given `Master` to be inserted at the given `InsertionPoint` - or `false` otherwise. `InsertionPoint` may be set to a specific component, a component name or a component's index in the list of components in this container. If it is missing, it is assumed that the new component should be appended
* **`newComponentInsertedAt (Master:WAT_Name, InsertionPoint?:WAT_Component|WAT_Name|number):WAT_Component`**<br>creates a new component based on the given `Master` and inserts it at the given `InsertionPoint`. `InsertionPoint` may be set to a specific component, a component name or a component's index in the list of components in this container. If it is missing, the new component is appended to the list of already existing components
* **`DuplicateOfComponent (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):WAT_Component`**<br>creates a duplicate of the given `ComponentOrNameOrIndex`and inserts it right after the original. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`ComponentDeserializedFrom (Serialization:string, InsertionPoint?:WAT_Component|WAT_Name|number):WAT_Component`**<br>creates a new component from the given `Serialization` and inserts it at the given `InsertionPoint`. `InsertionPoint` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`ComponentMayBeShiftedUp (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):boolean`**<br>returns `true` if the given `ComponentOrNameOrIndex` may be moved one position "up" (i.e. towards lower indices) in the list of components of this container - or `false` otherwise. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`ComponentMayBeShiftedDown (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):boolean`**<br>returns `true` if the given `ComponentOrNameOrIndex` may be moved one position "down" (i.e. towards higher indices) in the list of components of this container - or `false` otherwise. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`ComponentMayBeShiftedTo (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number, InsertionPoint:WAT_Component|WAT_Name|number):boolean`**<br>returns `true` if the given `ComponentOrNameOrIndex` may be moved to the position given by `InsertionPoint` in the list of components of this container - or `false` otherwise. Both `ComponentOrNameOrIndex` and `InsertionPoint` may be set to a specific component, a component name or a component's index in the list of components in this container. If it is missing, it is assumed that the given component should be appended
* **`shiftComponentUp (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):void`**<br>moves the given `ComponentOrNameOrIndex` one position "up" (i.e. towards lower indices) in the list of components of this container - provided that this is possible. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`shiftComponentDown (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):void`**<br>moves the given `ComponentOrNameOrIndex` one position "down" (i.e. towards higher indices) in the list of components of this container - provided that this is possible. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container
* **`shiftComponentTo (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number, InsertionPoint:WAT_Component|WAT_Name|number):void`**<br>moves the given `ComponentOrNameOrIndex` to the position given by `InsertionPoint` in the list of components of this container - provided that this is possible. Both `ComponentOrNameOrIndex` and `InsertionPoint` may be set to a specific component, a component name or a component's index in the list of components in this container. If it is missing, it is assumed that the given component should be appended
* **`removeComponent (ComponentOrNameOrIndex:WAT_Component|WAT_Name|number):void`**<br>removes the given `ComponentOrNameOrIndex` - provided that this is possible. `ComponentOrNameOrIndex` may be set to a specific component, a component name or a component's index in the list of components in this container. It is permitted to remove a non-existing component - in that case, the function is simply ignored
...
* **`mayBeShiftedTo(InsertionPoint:WAT_Card|WAT_Name|number):boolean`**<br>returns `true` if this card may be shifted to the the position given by `InsertionPoint` in this applet's list of cards - or `false` otherwise. `InsertionPoint` may be set to a specific card, a card name or a card's index in the list of cards in this applet. If it is missing, it is assumed that this card should be appended
...
* **`mayBeShiftedTo(InsertionPoint:WAT_Overlay|WAT_Name|number):boolean`**<br>returns `true` if this overlay may be shifted to the the position given by `InsertionPoint` in this applet's list of overlays - or `false` otherwise. `InsertionPoint` may be set to a specific overlay, an overlay name or an overlay's index in the list of overlays in this applet. If it is missing, it is assumed that this overlay should be appended
...
* **`mayBeDisplaced:boolean`**<br>contains `true` if the WAT designer is allowed to change the position of this component - or `false` otherwise
* **`mayBeDeformed:boolean`**<br>contains `true` if the WAT designer is allowed to change the size of this component - or `false` otherwise
* **`Index:number`**<br>contains the index of this component in its container's list of components
* **`mayBeShiftedUp:boolean`**<br>contains `true` if this component may be shifted "up" (i.e., towards lower indices) in its container's list of components - or `false` otherwise
* **`mayBeShiftedDown:boolean`**<br>contains `true` if this component may be shifted "down" (i.e., towards higher indices) in its container's list of components - or `false` otherwise
* **`mayBeShiftedTo (InsertionPoint:WAT_Control|WAT_Compound|WAT_Name|number):boolean`**<br>returns `true` if this component may be shifted to the the position given by `InsertionPoint` its container's list of components - or `false` otherwise. `InsertionPoint` may be set to a specific component, a component name or a component's index in its container's list of components. If it is missing, it is assumed that this component should be appended
* **`shiftUp ():void`**<br>moves this component one position "up" (i.e., towards lower indices) in its container's list of components - provided that this is possible
* **`shiftDown ():void`**<br>moves this component one position "down" (i.e., towards lower indices) in its container's list of components - provided that this is possible
* **`shiftTo (InsertionPoint:WAT_Control|WAT_Compound|WAT_Name|number):void`**<br>moves this component to the position given by `InsertionPoint` in its container's list of components - provided that this is possible. `InsertionPoint` may be set to a specific component, a component name or a component's index in its container's list of components. If it is missing, it is assumed that this component should be appended
* **`mayBeRemoved:boolean`**<br>contains `true` if the WAT designer is allowed to delete this component - or `false` otherwise
* **`remove ():void`**<br>removes this component - provided that this is possible
